...
<head>
    ...
    <title>E-Library Management System |  Issued Books</title>
...
<a href="borrow.php?q=login&id=<?php echo $id;?>"><img src="assets/img/booking/<?php echo htmlentities($result->bookImage);?>" width="100"></a>
