...
$isbn=$_POST['isbn'];
$price=$_POST['price'];
$booking=$_FILES["bookpic"]["name"];
// get the image extension
$extension = substr($booking,strlen($booking)-4,strlen($booking));
// allowed extensions
$allowed_extensions = array(".jpg","jpeg",".png",".gif");
// Validation for allowed extensions .in_array() function searches an array for a specific value.
//rename the image file
$imgnewname=md5($booking.time()).$extension;
...
{
move_uploaded_file($_FILES["bookpic"]["tmp_name"],"assets/img/booking/".$imgnewname);
...
if($lastInsertId)
{
echo "<script>alert('A new book added successfully');</script>";
...
<head>
    ...
    <title>E-Library Management System | Add Book</title>
